/**
 * Kiwify Webhook: Purchase Approved
 * @description Endpoint para receber notificações de compras aprovadas
 */
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // 4. Salvar webhook no banco (para auditoria)
...
// Desabilitar body parsing automático para poder verificar a assinatura
export const config = {
  api: {
    bodyParser: false,
  },
