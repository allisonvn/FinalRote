...
-- ==================================================================================
-- Este script diagnostica e corrige todos os problemas do sistema:
-- 1. Verifica e corrige estrutura das tabelas
-- 2. Recria funções RPC corretamente
-- 3. Adiciona triggers para inicialização automática
-- 4. Inicializa dados faltantes
-- ==================================================================================

\echo '🔧 Iniciando correção completa do sistema...'

-- ==================================================================================
-- PARTE 1: VERIFICAR E CORRIGIR ESTRUTURA DAS TABELAS
-- ==================================================================================
...
\echo '✅ Parte 1 concluída: Estrutura das tabelas verificada e corrigida'

-- ==================================================================================
-- PARTE 2: RECRIAR FUNÇÕES RPC CORRETAMENTE
-- ==================================================================================

\echo '📋 Parte 2: Recriando funções RPC...'
...
-- 2.3 Função para obter estatísticas do experimento
...
COMMENT ON FUNCTION get_experiment_stats IS 'Retorna estatísticas agregadas de experimentos e variantes';
...
COMMENT ON FUNCTION get_daily_conversions IS 'Retorna conversões por dia para um experimento';
...
BEGIN
    ...
    -- Calcular pooled rate e standard error
    ...
    -- Simplificação: z > 1.96 → p < 0.05, z > 2.58 → p < 0.01
...
COMMENT ON FUNCTION calculate_significance IS 'Calcula significância estatística entre controle e variante';

\echo '✅ Parte 2 concluída: Funções RPC recriadas'

-- ==================================================================================
-- PARTE 3: TRIGGERS PARA INICIALIZAÇÃO AUTOMÁTICA
-- ==================================================================================

\echo '📋 Parte 3: Criando triggers...'
...
AS $$
BEGIN
    -- Inicializar estatísticas para a nova variante
    INSERT INTO variant_stats (
        experiment_id,
        variant_id,
        visitors,
...
COMMENT ON FUNCTION init_variant_stats IS 'Inicializa estatísticas quando uma variante é criada';

\echo '✅ Parte 3 concluída: Triggers criados'

-- ==================================================================================
-- PARTE 4: INICIALIZAR DADOS FALTANTES
-- ==================================================================================

\echo '📋 Parte 4: Inicializando dados faltantes...'
...
\echo '✅ Parte 4 concluída: Dados inicializados'

-- ==================================================================================
-- PARTE 5: PERMISSIONS E RLS
-- ==================================================================================
...
\echo '✅ Parte 5 concluída: Permissões configuradas'
...
BEGIN
    ...
    IF v_triggers_count < 1 THEN
        RAISE WARNING 'Trigger de inicialização não foi criado!';
    END IF;
END $$;

\echo ''
\echo '🎉 Sistema completamente corrigido e pronto para uso!'
\echo ''
\echo 'Próximos passos:'
\echo '1. Teste o sistema criando um novo experimento no dashboard'
\echo '2. Verifique se as variantes são criadas com variant_stats inicializados'
\echo '3. Teste o tracking de eventos e conversões'
\echo '4. Verifique se as métricas são atualizadas corretamente'
\echo ''
